...
from qiskit_omelyan import Malezic_Ostmeyer6

from model import heisenbergXXZ

# This example demonstrates how to use the Malezic_Ostmeyer6 scheme to build
...
if __name__ == "__main__":
    ...
    malezic_ostmeyer6 = Malezic_Ostmeyer6(reps=reps, merge_single=merge_single, merge_steps=merge_steps)

    # ------------------ Time evolution circuit --------------------

    # 3) Build the circuit for the time evolution operator U(t) = exp(-i t H)
    evo = PauliEvolutionGate(H, time=t)
    evo_circuit = malezic_ostmeyer6.synthesize(evo)
