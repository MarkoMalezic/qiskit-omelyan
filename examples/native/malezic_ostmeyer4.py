...
from qiskit_omelyan import Malezic_Ostmeyer4

from model import heisenbergXXZ

# This example demonstrates how to use the Malezic_Ostmeyer4 scheme to build
...
if __name__ == "__main__":
    ...
    malezic_ostmeyer4 = Malezic_Ostmeyer4(reps=reps, merge_single=merge_single, merge_steps=merge_steps)
