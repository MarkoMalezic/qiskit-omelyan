...
from qiskit_omelyan import Blanes_Moan6
...
if __name__ == "__main__":
    ...
    blanes_moan6 = Blanes_Moan6(reps=reps, merge_single=merge_single, merge_steps=merge_steps)

    # ------------------ Time evolution circuit --------------------

    # 3) Build the circuit for the time evolution operator U(t) = exp(-i t H)
    evo = PauliEvolutionGate(H, time=t)
    evo_circuit = blanes_moan6.synthesize(evo)
